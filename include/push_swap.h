...
/*   Updated: 2023/11/27 12:18:54 by iusantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				apply_rarb(t_stack *stack_a, t_stack *stack_b, int nbr,
					char s);
int				apply_rrarrb(t_stack *stack_a, t_stack *stack_b, int nbr,
					char s);
int				apply_rarrb(t_stack *stack_a, t_stack *stack_b, int nbr,
					char s);
int				apply_rrarb(t_stack *stack_a, t_stack *stack_b, int nbr,
					char s);
...
int				sim_revrot_number_a(t_stack *stack_a, t_stack *stack_b,
					int nbr);
...
int				check_last(t_stack *stack_a, t_stack *stack_b, t_inode *tmp,
					int x);
int				min_cost_ba(t_stack *stack_a, t_stack *stack_b);
int				check_last_a(t_stack *stack_a, t_stack *stack_b, t_inode *tmp,
					int x);
